                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row items-baseline">
                            <div class="col-md-2">
                                <a href="{{ route('crud.create') }}" class="btn"
                            ...
                            <form id="delete-form" action="{{ route('crud.trash') }}" method="GET" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                            ...
                            <tbody>
                                @foreach ($cruds as $crud)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('crud.edit', ['crud' => $crud->id]) }}" style="color: #2c2c2c;"
                                                class="ms-1 me-1"><i class="far fa-edit"></i></a>
                                            <a href="{{ route('crud.show', ['crud' => $crud->id]) }}" style="color: #2c2c2c;"
                                                class="ms-1 me-1"><i class="far fa-eye"></i></a>
                                            <form id="delete-form-{{ $crud->id }}"
                                                action="{{ route('crud.destroy', ['crud' => $crud->id]) }}" method="POST"
                                                style="display: none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
